...
The regression analysis (see @fig-linear-regression-plot, @fig-linear-regression-diag, and @tbl-linear-regression-coef) reveals:
...
The multiple regression analysis (see @tbl-multiple-regression-vif, @fig-multiple-regression-diag, @fig-multiple-regression-effects, and @tbl-model-comparison) reveals several important insights:
