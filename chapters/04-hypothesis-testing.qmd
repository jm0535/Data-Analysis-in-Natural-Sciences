...
The t-test assumes the data are roughly normal. With large samples that assumption barely matters (the central limit theorem does the heavy lifting), but with smaller samples it is worth a quick look.
